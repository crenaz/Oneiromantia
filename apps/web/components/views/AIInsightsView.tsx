    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center border-b border-white/5 pb-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-2 bg-white/5 hover:bg-white/10 rounded-xl text-xs font-mono text-mist transition-all cursor-pointer"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="glass-panel p-6 rounded-2xl space-y-4">
          <div className="flex gap-3 items-start border-b border-white/5 pb-3">
            ...
            <div>
              <span className="font-mono text-[9px] text-mist/40 block">PSYCHO-EMOTIONAL REPORT</span>
          ...
          <p className="text-xs text-mist/80 leading-relaxed font-sans">
            Your subconscious emotional landscape is showing a steady transition towards <span className="text-aurora-cyan font-semibold">Integrative Serenity</span>. The active frequency of anxiety-laden dreamscapes has declined by <span className="text-red-400 font-semibold">24%</span>, replaced by expansion and geometric awe (Wonder), usually associated with resolution of awake-world stressors.
          </p>
          <div className="flex justify-between items-center text-[10px] font-mono text-mist/40 pt-2 border-t border-white/5">
            <span>STABILITY INDEX: 84%</span>
            <span className="text-aurora-cyan flex items-center gap-1">UPWARDS TREND <TrendingUp className="w-3 h-3" /></span>
          </div>
        </div>
        ...
        <div className="glass-panel p-6 rounded-2xl space-y-4">
          <div className="flex gap-3 items-start border-b border-white/5 pb-3">
            ...
            <div>
              <span className="font-mono text-[9px] text-mist/40 block">INTELLIGENCE RECOMMENDATION</span>
